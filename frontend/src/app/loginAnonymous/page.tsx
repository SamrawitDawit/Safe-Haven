  ...
  return (
    <div className="flex justify-center mt-0 ">
      <div className="flex flex-col gap-4 w-[480px] mt-50">
        ...
        <h2 className="text-[36px] text-center font-black font-poppins">Log in</h2>
        <h4 className='font-poppins text-base text-slate-500 text-center'>Welcome back! Please enter your details.</h4>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-1">
          ...
          <input
            ...
            className="bg-[#96D1D5] px-6 py-3 rounded-[80px] text-white font-epilogue font-bold text-[12px] mt-4"
          />
        </form>
